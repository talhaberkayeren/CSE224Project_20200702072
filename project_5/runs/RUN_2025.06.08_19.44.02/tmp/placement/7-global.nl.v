module cpu_top (clk,
 ...
 sky130_fd_sc_hd__buf_1 _064_ (.A(\U7.digit_counter[3] ),
    .X(_025_));
 ...
 sky130_fd_sc_hd__o31ai_2 _067_ (.A1(\U7.digit_counter[1] ),
    ...
    .B1(\U7.temp[0] ),
    .Y(_027_));
 sky130_fd_sc_hd__nand2_2 _068_ (.A(\U7.digit_counter[3] ),
 ...
 sky130_fd_sc_hd__o21ai_2 _069_ (.A1(_025_),
    ...
    .B1(_028_),
    .Y(_007_));
 sky130_fd_sc_hd__nand2_2 _070_ (.A(\U7.digit_counter[3] ),
    .B(\U7.current_digit[2] ),
    .Y(_029_));
 sky130_fd_sc_hd__inv_2 _071_ (.A(_029_),
    .Y(_009_));
 sky130_fd_sc_hd__nand2_2 _072_ (.A(_025_),
    .B(\U7.current_digit[3] ),
    .Y(_030_));
 sky130_fd_sc_hd__inv_2 _073_ (.A(_030_),
    .Y(_010_));
 sky130_fd_sc_hd__a21o_2 _074_ (.A1(_026_),
    .A2(_007_),
    .B1(_009_),
    .X(_031_));
 sky130_fd_sc_hd__and3_2 _075_ (.A(\U7.digit_counter[3] ),
    .B(\U7.current_digit[1] ),
    .C(\U7.current_digit[0] ),
    .X(_032_));
 sky130_fd_sc_hd__or2_2 _076_ (.A(_029_),
    .B(_032_),
    .X(_033_));
 sky130_fd_sc_hd__o211a_2 _077_ (.A1(_025_),
    .A2(_027_),
    .B1(_028_),
    .C1(_026_),
    .X(_034_));
 sky130_fd_sc_hd__a21oi_2 _078_ (.A1(_031_),
    ...
    .B1(_034_),
    .Y(_035_));
 sky130_fd_sc_hd__nor3_2 _079_ (.A(\U7.current_digit[1] ),
    .B(_007_),
    .C(_029_),
    .Y(_036_));
 sky130_fd_sc_hd__or2_2 _080_ (.A(_010_),
    .B(_036_),
    .X(_037_));
 sky130_fd_sc_hd__nand2_2 _081_ (.A(_010_),
    .B(_036_),
    .Y(_038_));
 sky130_fd_sc_hd__o21ai_2 _082_ (.A1(_035_),
    .A2(_037_),
    .B1(_038_),
    .Y(_000_));
 sky130_fd_sc_hd__and3_2 _083_ (.A(_025_),
    .B(\U7.current_digit[0] ),
 ...
 sky130_fd_sc_hd__and2b_2 _084_ (.A_N(_034_),
    .B(_033_),
    .X(_040_));
 sky130_fd_sc_hd__mux2_2 _085_ (.A0(_039_),
    .A1(_030_),
    .S(_040_),
    .X(_041_));
 sky130_fd_sc_hd__buf_1 _086_ (.A(_041_),
    .X(_001_));
 sky130_fd_sc_hd__o21bai_2 _087_ (.A1(\U7.current_digit[1] ),
    .A2(_029_),
    .B1_N(_007_),
    .Y(_042_));
 sky130_fd_sc_hd__and3_2 _088_ (.A(_026_),
    .B(_007_),
    .C(_029_),
    .X(_043_));
 sky130_fd_sc_hd__mux2_2 _089_ (.A0(_042_),
    .A1(_043_),
    .S(_010_),
    .X(_044_));
 sky130_fd_sc_hd__buf_1 _090_ (.A(_044_),
    .X(_002_));
 sky130_fd_sc_hd__or3_2 _091_ (.A(\U7.current_digit[2] ),
    .B(_026_),
    .C(_007_),
    .X(_045_));
 sky130_fd_sc_hd__a21oi_2 _092_ (.A1(\U7.current_digit[2] ),
    .A2(_032_),
    .B1(_030_),
    .Y(_046_));
 sky130_fd_sc_hd__or2_2 _093_ (.A(_034_),
    .B(_033_),
    .X(_047_));
 sky130_fd_sc_hd__a21oi_2 _094_ (.A1(_031_),
    .A2(_047_),
    .B1(_010_),
    .Y(_048_));
 sky130_fd_sc_hd__a21oi_2 _095_ (.A1(_045_),
    .A2(_046_),
    .B1(_048_),
    .Y(_003_));
 sky130_fd_sc_hd__inv_2 _096_ (.A(\U7.current_digit[2] ),
    .Y(_049_));
 sky130_fd_sc_hd__and2_2 _097_ (.A(_026_),
    .B(_007_),
    .X(_050_));
 sky130_fd_sc_hd__o21a_2 _098_ (.A1(_049_),
    .A2(_050_),
    .B1(_010_),
    .X(_051_));
 sky130_fd_sc_hd__a21oi_2 _099_ (.A1(_030_),
    .A2(_045_),
    .B1(_051_),
    .Y(_004_));
 sky130_fd_sc_hd__o22a_2 _100_ (.A1(_030_),
    .A2(_050_),
    .B1(_047_),
    .B2(\U7.current_digit[3] ),
    .X(_052_));
 sky130_fd_sc_hd__o21ba_2 _101_ (.A1(_007_),
    .A2(_009_),
    .B1_N(_052_),
    .X(_005_));
 sky130_fd_sc_hd__or2_2 _102_ (.A(_036_),
    .B(_043_),
    .X(_053_));
 sky130_fd_sc_hd__or2_2 _103_ (.A(_009_),
    .B(_032_),
    .X(_054_));
 ...
 sky130_fd_sc_hd__inv_2 _105_ (.A(\U7.digit_counter[1] ),
    .Y(_055_));
 sky130_fd_sc_hd__nand2_2 _106_ (.A(_055_),
    .B(\U7.digit_counter[0] ),
    .Y(_056_));
 sky130_fd_sc_hd__inv_2 _107_ (.A(\U7.digit_counter[0] ),
    .Y(_011_));
 sky130_fd_sc_hd__nand2_2 _108_ (.A(\U7.digit_counter[1] ),
    .B(_011_),
    .Y(_057_));
 sky130_fd_sc_hd__nand2_2 _109_ (.A(_056_),
    .B(_057_),
    .Y(_012_));
 sky130_fd_sc_hd__and3_2 _110_ (.A(\U7.digit_counter[1] ),
    .B(\U7.digit_counter[0] ),
    .C(\U7.digit_counter[2] ),
    .X(_058_));
 sky130_fd_sc_hd__a21oi_2 _111_ (.A1(\U7.digit_counter[1] ),
    .A2(\U7.digit_counter[0] ),
    .B1(\U7.digit_counter[2] ),
    .Y(_059_));
 sky130_fd_sc_hd__nor2_2 _112_ (.A(_058_),
    .B(_059_),
    .Y(_013_));
 sky130_fd_sc_hd__inv_2 _113_ (.A(_025_),
    .Y(_060_));
 sky130_fd_sc_hd__xnor2_2 _114_ (.A(_060_),
    .B(_058_),
    .Y(_014_));
 sky130_fd_sc_hd__or2_2 _115_ (.A(_025_),
    .B(\U7.digit_counter[2] ),
    .X(_061_));
 sky130_fd_sc_hd__and3b_2 _116_ (.A_N(_061_),
    .B(_011_),
    .C(_055_),
    .X(_062_));
 sky130_fd_sc_hd__a21o_2 _117_ (.A1(_025_),
    .A2(\U7.temp[0] ),
    .B1(_062_),
    .X(_015_));
 sky130_fd_sc_hd__o22a_2 _118_ (.A1(_060_),
    .A2(an[1]),
    .B1(_056_),
    .B2(_061_),
    .X(_016_));
 sky130_fd_sc_hd__o22a_2 _119_ (.A1(_060_),
    .A2(an[2]),
    .B1(_057_),
    .B2(_061_),
    .X(_017_));
 sky130_fd_sc_hd__o21ba_2 _120_ (.A1(_060_),
    .A2(an[0]),
    .B1_N(_062_),
    .X(_018_));
 sky130_fd_sc_hd__nand2_2 _121_ (.A(_060_),
    .B(\U7.digit_counter[2] ),
    .Y(_063_));
 sky130_fd_sc_hd__o32a_2 _122_ (.A1(\U7.digit_counter[1] ),
    .A2(\U7.digit_counter[0] ),
    .A3(_063_),
    .B1(an[4]),
    .B2(_060_),
    .X(_019_));
 sky130_fd_sc_hd__o22a_2 _123_ (.A1(_060_),
    .A2(an[5]),
    .B1(_056_),
    .B2(_063_),
    .X(_020_));
 sky130_fd_sc_hd__nand2_2 _124_ (.A(_025_),
    .B(an[7]),
    .Y(_024_));
 sky130_fd_sc_hd__o21ai_2 _125_ (.A1(_025_),
    .A2(_058_),
    .B1(_024_),
    .Y(_021_));
 sky130_fd_sc_hd__o22a_2 _126_ (.A1(_060_),
    .A2(an[6]),
    .B1(_057_),
    .B2(_063_),
    .X(_022_));
 sky130_fd_sc_hd__o32a_2 _127_ (.A1(_055_),
    .A2(_011_),
    .A3(_061_),
    .B1(an[3]),
    .B2(_060_),
 ...
 sky130_fd_sc_hd__dfxtp_2 _129_ (.CLK(clk),
    .D(_001_),
    .Q(cx[2]));
 sky130_fd_sc_hd__dfxtp_2 _130_ (.CLK(clk),
    .D(_002_),
    .Q(cx[3]));
 sky130_fd_sc_hd__dfxtp_2 _131_ (.CLK(clk),
    .D(_003_),
    .Q(cx[4]));
 sky130_fd_sc_hd__dfxtp_2 _132_ (.CLK(clk),
    .D(_004_),
    .Q(cx[5]));
 sky130_fd_sc_hd__dfxtp_2 _133_ (.CLK(clk),
    .D(_005_),
    .Q(cx[6]));
 sky130_fd_sc_hd__dfxtp_2 _134_ (.CLK(clk),
    .D(_006_),
    .Q(cx[7]));
 sky130_fd_sc_hd__dfxtp_2 _135_ (.CLK(clk),
    .D(_007_),
    .Q(\U7.current_digit[0] ));
 sky130_fd_sc_hd__dfxtp_2 _136_ (.CLK(clk),
    .D(_008_),
 ...
 sky130_fd_sc_hd__dfxtp_2 _151_ (.CLK(clk),
    .D(_023_),
    .Q(an[3]));
 sky130_fd_sc_hd__conb_1 _152_ (.HI(cx[0]));
